...
| **SPECS** `2025-specs`                            | Street perception evaluation considering demographics and personality (1,000+ participants, 5 countries). | Quintana et al. (2025) | [Nature Cities](https://www.nature.com/articles/s44284-025-00330-x)                                                           | 📖[HuggingFace](https://huggingface.co/datasets/matiasqr/specs) |
