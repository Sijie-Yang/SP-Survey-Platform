/**
 * Mirror of src/lib/designProtocol/skillAnalysisGuide.js for Workers / MCP / server.
 */

import { SKILL_RESULT_TYPES, skillResultTypesCatalogText } from './skillResultTypes.mjs';
