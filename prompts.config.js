// System prompts configuration (Node.js compatible)
...
2. IMAGE-BASED QUESTIONS (Type 2 - Streetscape perception):
   ...
   a) imagerating (rate multiple images):
...
Return COMPLETE modified survey. Pages: {"title": "...", "elements": [...]}
